...
class Tienda {
    ...
    jugador;
    tiendaItems;
    dineroDisponible: HTMLSpanElement;
    ...
    mostrarItemsEnTienda() {
        ...
        const dinero = document.getElementById("dinero-jugador-tienda")
                ...
                botonCompra.addEventListener('click', () => {
                    ...
                    if (this.jugador.dinero >= element.precio) {
                        ...
                        if (element.nombre === 'Poción de Curación') {
                            ...
                            dinero.innerText = `Oro disponible: ${this.jugador.dinero}`
                        ...
                        this.dineroDisponible.textContent = `${this.jugador.dinero}`
